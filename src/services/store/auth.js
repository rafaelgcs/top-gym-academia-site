...
const TOKEN_KEY = process.env.REACT_APP_TOKEN_KEY_STORE
const USER_KEY = process.env.REACT_APP_USER_KEY_STORE
const EXPIRES_IN_KEY = process.env.REACT_APP_EXPIRES_IN_KEY_STORE
const LAST_LOGIN_KEY = process.env.REACT_APP_LAST_LOGIN_KEY_STORE
const REMEMBER_USER_KEY = process.env.REACT_APP_REMEMBER_USER_KEY_STORE
