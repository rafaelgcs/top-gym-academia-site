...
import EquipeHeader from '../../shared/components/Headers/EquipeHeader';
...
const EquipePage = (props) => {
    const [imageTop, setImageTop] = useState(<img src={require('../../shared/assets/img/logo-50x-black.png')} />);
            ...
            <Col md={12}>
                <Row>
                                        ...
                                        <Card className="card-profile card-plain">
                                            <div className="card-avatar">
                                                <a href="#" onClick={e => e.preventDefault()}>
                                                    <img
                                                        alt="..."
                                                        src={require("../../shared/assets/img/faces/default-m.png")}
                                                    />
                                                </a>
                                            </div>
                                            <CardBody>
                    ...
                    <Col className="section-dark d-none d-md-block"
                        style={{
                            backgroundImage:
                                "url(" + require("../../shared/assets/img/bank/gym-03.jpg") + ")",
            ...
            <Col md={12}>
                <Row>
                    <Col className="section-dark d-none d-md-block"
                        style={{
                            backgroundImage:
                                "url(" + require("../../shared/assets/img/bank/gym-02.jpg") + ")",
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                        }}></Col>
                    <Col md={6} className="section section-dark text-center">
                                        ...
                                        <Card className="card-profile card-plain">
                                            <div className="card-avatar">
                                                <a href="#pablo" onClick={e => e.preventDefault()}>
                                                    <img
                                                        alt="..."
                                                        src={require("../../shared/assets/img/faces/default-f.png")}
                                                    />
                                                </a>
                                            </div>
                                            <CardBody>
            ...
            <Col md={12}>
                <Row>
                    ...
                    <Col className="section-dark d-none d-md-block"
                        style={{
                            backgroundImage:
                                "url(" + require("../../shared/assets/img/bank/gym-01.jpg") + ")",
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                        }}></Col>
